...
const gameMeta: { id: GameId; label: string; note: string; total: number; href: string }[] = [
  ...
  { id: "prompt-workshop", label: "Prompt Workshop", note: "Build, don't guess", total: 3, href: "/play?game=workshop" },
  { id: "source-hunt", label: "Source Hunt", note: "Sequence the check", total: 3, href: "/play?game=source-hunt" },
];
